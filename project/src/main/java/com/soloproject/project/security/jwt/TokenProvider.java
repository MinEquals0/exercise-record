...
public class TokenProvider implements InitializingBean {
    ...
    @Value("${jwt.secret}")
    private String secret; // yml에서 secret 값을 받아옴
    private long tokenValidityInMilliseconds; // yml에서 토큰 만료 시간을 받아옴
    private Key key;


    // 빈이 생성 되고 DI한 다음에 주입 받은 secret 값을
    ...
    // Authentication 객체에 있는 인증을 받은 유저 정보를 이용해 토큰을 생성
    ...
    // 토큰을 매개변수로 받아 토큰에 담겨있는 정보를 이용 Authentication객체 리턴하는 메소드
    // 토큰에서 사용자 정보 가져오기
